 <?php
    ...
    class Muser extends CI_Model
    {
        ...
        public function login($inputan)
        {
            ...
            if (!empty($petugas)) {
                if ($petugas['level'] == 'admin') {
                    ...
                    return "admin";
                } elseif ($petugas['level'] == 'customer') {
                    $this->session->set_userdata("customer", $petugas);
                    return "customer";
                } else {
                    return "gagal";
                }
        ...
        function ubah_profilcustomer($inputan, $id_user)
        {
            // jika inputan['password'] kosong
            if (empty($inputan['password'])) {
                // buang dari array inputan agar tidak di update
            ...
            // update session user_petugas dengan data user_petugas yang ter update
            $this->session->set_userdata("customer", $user_petugas);
        }
