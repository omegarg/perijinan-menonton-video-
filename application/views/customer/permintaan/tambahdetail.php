...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url('customer/permintaan/detail/' . $id_permintaan); ?>">Detail</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data">
                <div class="row">
                    <input type="hidden" class="form-control" id="id_permintaan" name="id_permintaan" value="<?= $id_permintaan; ?>" readonly>
        ...
        <div class=" card-footer text-md-right">
            <a href="<?= base_url('customer/permintaan/detail/' . $id_permintaan); ?>" class="btn btn-secondary">Batal</a>
